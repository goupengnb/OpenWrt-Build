...
#Argon Theme
git clone --depth=1 --single-branch --branch $(echo $OpenWrt_URL | grep -iq "lede" && echo "18.06" || echo "master") git clone -b 18.06 https://github.com/jerrykuku/luci-theme-argon.git luci-theme-argon
