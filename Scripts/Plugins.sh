...
#Argon Theme
git clone --depth=1 --single-branch git clone -b 18.06 https://github.com/jerrykuku/luci-theme-argon.git ./package/lean/luci-theme-argon
git clone --depth=1 --single-branch git clone -b 18.06 https://github.com/jerrykuku/luci-app-argon-config.git ./package/lean/luci-app-argon-config
#Pass Wall 
